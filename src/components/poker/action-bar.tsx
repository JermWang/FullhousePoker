      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        {canRaise && (
          <button
            type="button"
            onClick={submitRaise}
            className="flex-1 rounded-xl px-5 py-3 text-sm font-semibold text-white transition-[filter] hover:brightness-110"
            style={{
              background: "linear-gradient(180deg,#60a5fa,#2563eb)",
              boxShadow:
                "0 8px 20px -8px rgba(59,130,246,0.7), inset 0 1px 0 rgba(255,255,255,0.18)",
            }}
          >
        ...
        <button
          ...
          className="rounded-xl px-4 py-3 text-sm font-semibold text-charcoal-900 transition-[filter] hover:brightness-110"
          style={{
            background: "linear-gradient(180deg,#ffe07a,#ffd24a)",
            border: "1px solid rgba(255,210,74,0.6)",
            boxShadow: "0 8px 20px -8px rgba(255,210,74,0.6)",
          }}
        >

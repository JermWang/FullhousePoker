  ...
  return (
    <div className="flex h-[calc(100dvh-6.5rem)] flex-col gap-2.5">
      ...
      <div className="flex min-h-0 flex-1 flex-col gap-2.5 landscape:flex-row landscape:gap-3 lg:flex-row lg:gap-3">
        ...
        style={{
          background:
            "radial-gradient(120% 90% at 50% 8%, rgba(20,210,200,0.12), transparent 55%), #0e0524",
        }}
      >
          ...
          <div className="pointer-events-none absolute" style={{ inset: "3.2% 8.1%" }}>
            <div
              style={{
                ...
                borderRadius: "50%",
                background:
                  "linear-gradient(180deg,#2c1556 0%,#1c0d38 60%,#140a28 100%)",
                padding: 20,
                boxSizing: "border-box",
                boxShadow:
                  "0 44px 90px -38px rgba(0,0,0,0.85), inset 0 2px 0 rgba(255,255,255,0.06), inset 0 0 0 1px rgba(59,130,246,0.3), inset 0 -8px 20px rgba(0,0,0,0.5)",
              }}
            >
              <div
                style={{
                  ...
                  overflow: "hidden",
                  background:
                    "radial-gradient(ellipse at 50% 40%, #157d77 0%, #0e5d5a 50%, #073f3d 100%)",
                  boxShadow:
                    "inset 0 0 70px rgba(0,0,0,0.5), inset 0 0 0 2px rgba(255,255,255,0.05), inset 0 0 0 7px rgba(7,63,61,0.55)",
                }}
              >
                <div
                  style={{
  ...
  useEffect(() => {
    ...
    if (isYourTurn && !prev.current) {
      ...
      if (typeof document !== "undefined") {
        document.title = "🔔 Your turn — Fullhouse Poker";
      }

    ...
    >
      ...
      <div className={cn("relative", compact && "z-10")}>
            ...
            isToAct
              ? {
                  boxShadow: urgent
                    ...
                    : "0 0 0 2px #3b82f6, 0 0 13px rgba(59,130,246,0.5)",
                }
              : undefined
          }
        >
        ...
        {isDealer && (
          ...
          <span className="absolute top-1/2 -right-2.5 -translate-y-1/2 grid h-5 w-5 place-items-center rounded-full bg-amber text-[10px] font-bold text-charcoal-900 ring-2 ring-charcoal-900">
            D
          </span>
        )}
      </div>
      ...
      >
        ...
        <p
          ...
          style={{ color: seat.isAllIn ? "#ffe07a" : "#ffe7a8" }}
        >

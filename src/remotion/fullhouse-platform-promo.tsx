...
function BrandMark({ small = false }: { small?: boolean }) {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: small ? 16 : 24 }}>
      <Img
        src={staticFile("fullhouse-chip.svg")}
        style={{
          width: small ? 58 : 92,
          height: small ? 58 : 92,
          objectFit: "contain",
          filter: "drop-shadow(0 8px 26px rgba(59,130,246,0.5))",
        }}
      />
      <div
        style={{
      ...
      >
        Full<span style={{ color: theme.colors.velvetSoft }}>house</span>
      </div>
    </div>
  );
}
  ...
  return (
    <div
      style={{
        ...
        background:
          "radial-gradient(125% 120% at 50% -10%, #f8f5fc 0%, #efe9f7 72%, #e3dcf0 100%)",
        boxShadow:
          "0 34px 54px rgba(0,0,0,0.42), inset 0 1px 0 rgba(255,255,255,0.8), inset 0 0 0 1px rgba(60,40,90,0.14)",
        display: "grid",
        placeItems: "center",
        zIndex: index,
      }}
  ...
  return (
    <GlassPanel
      style={{
        padding: 22,
        minHeight: 130,
        borderColor: selected ? "rgba(59,130,246,0.62)" : "rgba(255,255,255,0.09)",
        boxShadow: selected
          ? "0 30px 80px -28px rgba(0,0,0,0.82), 0 0 36px -12px rgba(59,130,246,0.48)"
...
function AppShell({ frame }: { frame: number }) {
  ...
  const rows = ["The Penthouse", "Founders Table", "Solana Highline"];
  return (
    <GlassPanel
      style={{
        position: "absolute",
    ...
    >
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(ellipse at center, #157d77 0%, #0e5d5a 55%, #073f3d 100%)",
          border: "18px solid rgba(28,13,56,0.95)",
        ...
        return (
          <div
            ...
            style={{
              ...
              borderRadius: 16,
              border: i === 0 ? "1px solid rgba(59,130,246,0.65)" : "1px solid rgba(255,255,255,0.1)",
...
export const FullhousePlatformPromo = () => {
    ...
    >
      <div
        style={{
          ...
          inset: 0,
          backgroundImage: [
            "radial-gradient(60rem 60rem at 80% -10%, rgba(59,130,246,0.14), transparent 60%)",
      ...
      >
        <div>
          ...
          >
            Fullhouse Poker brings poker, Solana settlement, and operational controls into one buzzing neon room.
          </div>
        </div>
      </div>

# Deploying Fullhouse Poker (Railway)

Fullhouse Poker runs as **two services** that share one repo and the Supabase
database:
...
```bash
railway init             # creates a project; name it "Fullhouse Poker"
```
